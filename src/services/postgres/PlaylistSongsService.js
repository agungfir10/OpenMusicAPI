...
class PlaylistSongsService {
    ...
    async deleteSongFromPlaylistById(playlistId, songId) {
        ...
        if (!rows.length) {
            throw new NotFoundError('Lagu gagal di hapus dari playlist. lagu tidak ditemukan');
        }
    }
    ...
    async deletePlaylistById(playlistId) {
        ...
        if (!rows.length) {
            throw new NotFoundError('Playlist gagal di hapus dari playlist. playlist tidak ditemukan');
        } else {
